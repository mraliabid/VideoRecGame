...
#load test images By giving your image to recognize path
...
#display both images
cv2.imshow("View", cv2.resize(predicted_img1, (400, 500)))

cv2.imshow(subjects[1], cv2.resize(predicted_img4, (400, 500)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
